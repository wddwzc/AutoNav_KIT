...
#include "laser_slam_algorithm/srv_relocalization.h"
...
pcl::PointCloud<pcl::PointXYZINormal>::Ptr* laserCloudCornerArray;
pcl::PointCloud<pcl::PointXYZINormal>::Ptr* laserCloudSurfArray;
pcl::PointCloud<pcl::PointXYZINormal>::Ptr* laserCloudCornerArray2;
pcl::PointCloud<pcl::PointXYZINormal>::Ptr* laserCloudSurfArray2;
...
bool get_prior_map()
{
	...
	laserCloudSurfArray = new pcl::PointCloud<pcl::PointXYZINormal>::Ptr[laserCloudNum] ;
	laserCloudCornerArray = new pcl::PointCloud<pcl::PointXYZINormal>::Ptr[laserCloudNum] ;
	laserCloudSurfArray2 = new pcl::PointCloud<pcl::PointXYZINormal>::Ptr[laserCloudNum] ;
	laserCloudCornerArray2 = new pcl::PointCloud<pcl::PointXYZINormal>::Ptr[laserCloudNum] ;
...
bool relocalizationHandler(laser_slam_algorithm::srv_relocalization::Request &req,
				     laser_slam_algorithm::srv_relocalization::Response &res)
{
	surf_bfile.clear();
    corner_bfile.clear();
